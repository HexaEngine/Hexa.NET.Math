namespace Hexa.NET.Mathematics
{
    ...
    public static unsafe partial class MathUtil
    {
        ...
        public static float MultiplyAddEstimate(float left, float right, float addend)
        {
            ...
            return float.MultiplyAddEstimate(left, right, addend);
#else
        ...
        {
#if NET9_0_OR_GREATER
            return double.MultiplyAddEstimate(left, right, addend);
#else
            return (left * right) + addend;
#endif
        }
        ...
        {
#if NET9_0_OR_GREATER
            return float.FusedMultiplyAdd(left, right, addend);
#else
            return (left * right) + addend;
#endif
        }
        ...
        {
#if NET9_0_OR_GREATER
            return double.FusedMultiplyAdd(left, right, addend);
#else
            return (left * right) + addend;
#endif
        }
