...
namespace Hexa.NET.Mathematics
{
    ...
    public struct Matrix4x4D : IEquatable<Matrix4x4D>
    {
        ...
        private const double BillboardMinAngle = 1.0f - (0.1f * (MathF.PI / 180.0f)); // 0.1 degrees
        private const double DecomposeEpsilon = 0.0001f;

        private static readonly Matrix4x4D _identity = new Matrix4x4D
        (
            1f, 0f, 0f, 0f,
            0f, 1f, 0f, 0f,
            0f, 0f, 1f, 0f,
        ...
        /// <summary>Creates a <see cref="System.Numerics.Matrix4x4D" /> object from a specified <see cref="System.Numerics.Matrix3x2" /> object.</summary>
        /// <param name="value">A 3x2 matrix.</param>
        /// <remarks>This constructor creates a 4x4 matrix whose <see cref="System.Numerics.Matrix4x4D.M13" />, <see cref="System.Numerics.Matrix4x4D.M14" />, <see cref="System.Numerics.Matrix4x4D.M23" />, <see cref="System.Numerics.Matrix4x4D.M24" />, <see cref="System.Numerics.Matrix4x4D.M31" />, <see cref="System.Numerics.Matrix4x4D.M32" />, <see cref="System.Numerics.Matrix4x4D.M34" />, and <see cref="System.Numerics.Matrix4x4D.M43" /> components are zero, and whose <see cref="System.Numerics.Matrix4x4D.M33" /> and <see cref="System.Numerics.Matrix4x4D.M44" /> components are one.</remarks>
        ...
        /// <remarks>The <see cref="System.Numerics.Matrix4x4D.op_Addition" /> method defines the operation of the addition operator for <see cref="System.Numerics.Matrix4x4D" /> objects.</remarks>
        public static unsafe Matrix4x4D operator +(Matrix4x4D value1, Matrix4x4D value2)
        {
#if NET5_0_OR_GREATER
            if (AdvSimd.Arm64.IsSupported)
            {
                AdvSimd.Store(&value1.M11, AdvSimd.Arm64.Add(AdvSimd.LoadVector128(&value1.M11), AdvSimd.LoadVector128(&value2.M11)));  
                AdvSimd.Store(&value1.M11 + 2, AdvSimd.Arm64.Add(AdvSimd.LoadVector128(&value1.M11 + 2), AdvSimd.LoadVector128(&value2.M11 + 2)));     
                AdvSimd.Store(&value1.M21, AdvSimd.Arm64.Add(AdvSimd.LoadVector128(&value1.M21), AdvSimd.LoadVector128(&value2.M21)));
                AdvSimd.Store(&value1.M21 + 2, AdvSimd.Arm64.Add(AdvSimd.LoadVector128(&value1.M21 + 2), AdvSimd.LoadVector128(&value2.M21 + 2)));
                AdvSimd.Store(&value1.M31, AdvSimd.Arm64.Add(AdvSimd.LoadVector128(&value1.M31), AdvSimd.LoadVector128(&value2.M31)));
                AdvSimd.Store(&value1.M31 + 2, AdvSimd.Arm64.Add(AdvSimd.LoadVector128(&value1.M31 + 2), AdvSimd.LoadVector128(&value2.M31 + 2)));
                AdvSimd.Store(&value1.M41, AdvSimd.Arm64.Add(AdvSimd.LoadVector128(&value1.M41), AdvSimd.LoadVector128(&value2.M41)));
                AdvSimd.Store(&value1.M41 + 2, AdvSimd.Arm64.Add(AdvSimd.LoadVector128(&value1.M41 + 2), AdvSimd.LoadVector128(&value2.M41 + 2)));
                return value1;
            }
#if NET8_0_OR_GREATER
            else if (Avx512F.IsSupported)
            {
                Avx512F.Store(&value1.M11, Avx512F.Add(Avx512F.LoadVector512(&value1.M11), Avx512F.LoadVector512(&value2.M11)));
                Avx512F.Store(&value1.M31, Avx512F.Add(Avx512F.LoadVector512(&value1.M31), Avx512F.LoadVector512(&value2.M31)));
            ...
            {
                Avx.Store(&value1.M11, Avx.Add(Avx.LoadVector256(&value1.M11), Avx.LoadVector256(&value2.M11)));
                Avx.Store(&value1.M21, Avx.Add(Avx.LoadVector256(&value1.M21), Avx.LoadVector256(&value2.M21)));
                Avx.Store(&value1.M31, Avx.Add(Avx.LoadVector256(&value1.M31), Avx.LoadVector256(&value2.M31)));
                Avx.Store(&value1.M41, Avx.Add(Avx.LoadVector256(&value1.M41), Avx.LoadVector256(&value2.M41)));
                return value1;
            }
            else if (Sse2.IsSupported)
            {
                Sse2.Store(&value1.M11, Sse2.Add(Sse2.LoadVector128(&value1.M11), Sse2.LoadVector128(&value2.M11)));
                Sse2.Store(&value1.M11 + 2, Sse2.Add(Sse2.LoadVector128(&value1.M11 + 2), Sse2.LoadVector128(&value2.M11 + 2)));
                Sse2.Store(&value1.M21, Sse2.Add(Sse2.LoadVector128(&value1.M21), Sse2.LoadVector128(&value2.M21)));
                Sse2.Store(&value1.M21 + 2, Sse2.Add(Sse2.LoadVector128(&value1.M21 + 2), Sse2.LoadVector128(&value2.M21 + 2)));
                Sse2.Store(&value1.M31, Sse2.Add(Sse2.LoadVector128(&value1.M31), Sse2.LoadVector128(&value2.M31)));
                Sse2.Store(&value1.M31 + 2, Sse2.Add(Sse2.LoadVector128(&value1.M31 + 2), Sse2.LoadVector128(&value2.M31 + 2)));
                Sse2.Store(&value1.M41, Sse2.Add(Sse2.LoadVector128(&value1.M41), Sse2.LoadVector128(&value2.M41)));
                Sse2.Store(&value1.M41 + 2, Sse2.Add(Sse2.LoadVector128(&value1.M41 + 2), Sse2.LoadVector128(&value2.M41 + 2)));
                return value1;
            }
        ...
        public static unsafe bool operator ==(Matrix4x4D value1, Matrix4x4D value2)
        {
#if NET5_0_OR_GREATER
            if (AdvSimd.Arm64.IsSupported)
            {
                return VectorMath.Equal(AdvSimd.LoadVector128(&value1.M11), AdvSimd.LoadVector128(&value2.M11)) &&
                       VectorMath.Equal(AdvSimd.LoadVector128(&value1.M11 + 2), AdvSimd.LoadVector128(&value2.M11 + 2)) &&
                       VectorMath.Equal(AdvSimd.LoadVector128(&value1.M21), AdvSimd.LoadVector128(&value2.M21)) &&
                       VectorMath.Equal(AdvSimd.LoadVector128(&value1.M21 + 2), AdvSimd.LoadVector128(&value2.M21 + 2)) &&
                       VectorMath.Equal(AdvSimd.LoadVector128(&value1.M31), AdvSimd.LoadVector128(&value2.M31)) &&
                       VectorMath.Equal(AdvSimd.LoadVector128(&value1.M31 + 2), AdvSimd.LoadVector128(&value2.M31 + 2)) &&
                       VectorMath.Equal(AdvSimd.LoadVector128(&value1.M41), AdvSimd.LoadVector128(&value2.M41)) && 
                       VectorMath.Equal(AdvSimd.LoadVector128(&value1.M41 + 2), AdvSimd.LoadVector128(&value2.M41 + 2));
            }
#if NET8_0_OR_GREATER
            if (Avx512F.IsSupported)
            {
                return VectorMath.Equal(Avx512F.LoadVector512(&value1.M11), Avx512F.LoadVector512(&value2.M11)) &&
                       VectorMath.Equal(Avx512F.LoadVector512(&value1.M31), Avx512F.LoadVector512(&value2.M31));
            }
#endif
            else if (Avx.IsSupported)
            {
            ...
            else if (Sse2.IsSupported)
            {
                return VectorMath.Equal(Sse2.LoadVector128(&value1.M11), Sse2.LoadVector128(&value2.M11)) &&
                       VectorMath.Equal(Sse2.LoadVector128(&value1.M11 + 2), Sse2.LoadVector128(&value2.M11 + 2)) &&
                       VectorMath.Equal(Sse2.LoadVector128(&value1.M21), Sse2.LoadVector128(&value2.M21)) &&
                       VectorMath.Equal(Sse2.LoadVector128(&value1.M21 + 2), Sse2.LoadVector128(&value2.M21 + 2)) &&
                       VectorMath.Equal(Sse2.LoadVector128(&value1.M31), Sse2.LoadVector128(&value2.M31)) &&
                       VectorMath.Equal(Sse2.LoadVector128(&value1.M31 + 2), Sse2.LoadVector128(&value2.M31 + 2)) &&
                       VectorMath.Equal(Sse2.LoadVector128(&value1.M41), Sse2.LoadVector128(&value2.M41)) &&
                       VectorMath.Equal(Sse2.LoadVector128(&value1.M41 + 2), Sse2.LoadVector128(&value2.M41 + 2));
        ...
        public static unsafe bool operator !=(Matrix4x4D value1, Matrix4x4D value2)
        {
            ...
            if (AdvSimd.Arm64.IsSupported)
            {
                return VectorMath.NotEqual(AdvSimd.LoadVector128(&value1.M11), AdvSimd.LoadVector128(&value2.M11)) &&
                       VectorMath.NotEqual(AdvSimd.LoadVector128(&value1.M11 + 2), AdvSimd.LoadVector128(&value2.M11 + 2)) &&
                       VectorMath.NotEqual(AdvSimd.LoadVector128(&value1.M21), AdvSimd.LoadVector128(&value2.M21)) &&
                       VectorMath.NotEqual(AdvSimd.LoadVector128(&value1.M21 + 2), AdvSimd.LoadVector128(&value2.M21 + 2)) &&
                       VectorMath.NotEqual(AdvSimd.LoadVector128(&value1.M31), AdvSimd.LoadVector128(&value2.M31)) &&
                       VectorMath.NotEqual(AdvSimd.LoadVector128(&value1.M31 + 2), AdvSimd.LoadVector128(&value2.M31 + 2)) &&
                       VectorMath.NotEqual(AdvSimd.LoadVector128(&value1.M41), AdvSimd.LoadVector128(&value2.M41)) &&
                       VectorMath.NotEqual(AdvSimd.LoadVector128(&value1.M41 + 2), AdvSimd.LoadVector128(&value2.M41 + 2));
            }
#if NET8_0_OR_GREATER
            if (Avx512F.IsSupported)
            {
                return VectorMath.NotEqual(Avx512F.LoadVector512(&value1.M11), Avx512F.LoadVector512(&value2.M11)) &&
                       VectorMath.NotEqual(Avx512F.LoadVector512(&value1.M31), Avx512F.LoadVector512(&value2.M31));
            }
#endif
            else if (Avx.IsSupported)
            {
            ...
            else if (Sse2.IsSupported)
            {
                return VectorMath.NotEqual(Sse2.LoadVector128(&value1.M11), Sse2.LoadVector128(&value2.M11)) &&
                       VectorMath.NotEqual(Sse2.LoadVector128(&value1.M11 + 2), Sse2.LoadVector128(&value2.M11 + 2)) &&
                       VectorMath.NotEqual(Sse2.LoadVector128(&value1.M21), Sse2.LoadVector128(&value2.M21)) &&
                       VectorMath.NotEqual(Sse2.LoadVector128(&value1.M21 + 2), Sse2.LoadVector128(&value2.M21 + 2)) &&
                       VectorMath.NotEqual(Sse2.LoadVector128(&value1.M31), Sse2.LoadVector128(&value2.M31)) &&
                       VectorMath.NotEqual(Sse2.LoadVector128(&value1.M31 + 2), Sse2.LoadVector128(&value2.M31 + 2)) &&
                       VectorMath.NotEqual(Sse2.LoadVector128(&value1.M41), Sse2.LoadVector128(&value2.M41)) &&
                       VectorMath.NotEqual(Sse2.LoadVector128(&value1.M41 + 2), Sse2.LoadVector128(&value2.M41 + 2));
        ...
        /// <remarks>The <see cref="System.Numerics.Matrix4x4D.op_Multiply" /> method defines the operation of the multiplication operator for <see cref="System.Numerics.Matrix4x4D" /> objects.</remarks>
        public static unsafe Matrix4x4D operator *(Matrix4x4D value1, Matrix4x4D value2)
        {
#if NET5_0_OR_GREATER
            if (AdvSimd.Arm64.IsSupported)
            {
                ...
                Vector128<double> vX = AdvSimd.Arm64.MultiplyBySelectedScalar(AdvSimd.LoadVector128(&value2.M11), M11, 0);
                Vector128<double> vY = AdvSimd.Arm64.MultiplyBySelectedScalar(AdvSimd.LoadVector128(&value2.M21), M11, 1);
            ...
            {
                Vector128<double> row = Sse2.LoadVector128(&value1.M11);
                Sse2.Store(&value1.M11,
                    Sse2.Add(Sse2.Add(Sse2.Multiply(Sse2.Shuffle(row, row, 0x00), Sse2.LoadVector128(&value2.M11)),
                                    Sse2.Multiply(Sse2.Shuffle(row, row, 0x55), Sse2.LoadVector128(&value2.M21))),
                            Sse2.Add(Sse2.Multiply(Sse2.Shuffle(row, row, 0xAA), Sse2.LoadVector128(&value2.M31)),
                                    Sse2.Multiply(Sse2.Shuffle(row, row, 0xFF), Sse2.LoadVector128(&value2.M41)))));

                row = Sse2.LoadVector128(&value1.M21);
                Sse2.Store(&value1.M21,
                    Sse2.Add(Sse2.Add(Sse2.Multiply(Sse2.Shuffle(row, row, 0x00), Sse2.LoadVector128(&value2.M11)),
                                    Sse2.Multiply(Sse2.Shuffle(row, row, 0x55), Sse2.LoadVector128(&value2.M21))),
                            Sse2.Add(Sse2.Multiply(Sse2.Shuffle(row, row, 0xAA), Sse2.LoadVector128(&value2.M31)),
                                    Sse2.Multiply(Sse2.Shuffle(row, row, 0xFF), Sse2.LoadVector128(&value2.M41)))));

                row = Sse2.LoadVector128(&value1.M31);
                Sse2.Store(&value1.M31,
                    Sse2.Add(Sse2.Add(Sse2.Multiply(Sse2.Shuffle(row, row, 0x00), Sse2.LoadVector128(&value2.M11)),
                                    Sse2.Multiply(Sse2.Shuffle(row, row, 0x55), Sse2.LoadVector128(&value2.M21))),
                            Sse2.Add(Sse2.Multiply(Sse2.Shuffle(row, row, 0xAA), Sse2.LoadVector128(&value2.M31)),
                                    Sse2.Multiply(Sse2.Shuffle(row, row, 0xFF), Sse2.LoadVector128(&value2.M41)))));

                row = Sse2.LoadVector128(&value1.M41);
                Sse2.Store(&value1.M41,
                    Sse2.Add(Sse2.Add(Sse2.Multiply(Sse2.Shuffle(row, row, 0x00), Sse2.LoadVector128(&value2.M11)),
                                    Sse2.Multiply(Sse2.Shuffle(row, row, 0x55), Sse2.LoadVector128(&value2.M21))),
                            Sse2.Add(Sse2.Multiply(Sse2.Shuffle(row, row, 0xAA), Sse2.LoadVector128(&value2.M31)),
                                    Sse2.Multiply(Sse2.Shuffle(row, row, 0xFF), Sse2.LoadVector128(&value2.M41)))));
        ...
        /// <remarks>The <see cref="System.Numerics.Matrix4x4D.op_Multiply" /> method defines the operation of the multiplication operator for <see cref="System.Numerics.Matrix4x4D" /> objects.</remarks>
        public static unsafe Matrix4x4D operator *(Matrix4x4D value1, float value2)
        {
        ...
        /// <remarks>The <see cref="System.Numerics.Matrix4x4D.op_Subtraction" /> method defines the operation of the subtraction operator for <see cref="System.Numerics.Matrix4x4D" /> objects.</remarks>
        public static unsafe Matrix4x4D operator -(Matrix4x4D value1, Matrix4x4D value2)
        {
            if (AdvSimd.IsSupported)
            {
        ...
        public static unsafe Matrix4x4D operator -(Matrix4x4D value)
        {
            if (AdvSimd.IsSupported)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe bool Invert(Matrix4x4D matrix, out Matrix4x4D result)
        {
            ...
            static unsafe bool SseImpl(Matrix4x4D matrix, out Matrix4x4D result)
            {
                if (!Sse.IsSupported)
                {
                ...
                {
                    result = new Matrix4x4D(float.NaN, float.NaN, float.NaN, float.NaN,
                ...
                ref Vector128<float> vResult = ref Unsafe.As<Matrix4x4D, Vector128<float>>(ref result);
            ...
            static bool SoftwareFallback(Matrix4x4D matrix, out Matrix4x4D result)
            {
                //                                       -1
        ...
        public static unsafe Matrix4x4D Lerp(Matrix4x4D matrix1, Matrix4x4D matrix2, float amount)
        {
            if (AdvSimd.IsSupported)
            {
        ...
        /// <remarks>The current instance and <paramref name="obj" /> are equal if <paramref name="obj" /> is a <see cref="System.Numerics.Matrix4x4D" /> object and the corresponding elements of each matrix are equal.</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
